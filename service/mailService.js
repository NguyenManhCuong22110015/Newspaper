...
const sendConfirmationEmail = async (email, confirmationCode) => {
  ...
  const mailOptions = {
    ...
    html: `<div style=" margin: 0 auto; max-width: 600px;">
        <div style="display: flex; align-items: center;">
            ...
            <p style="font-family: 'Brush Script MT', cursive, sans-serif;font-size:40px" >NewsPapaper</p>
        </div>
        ...
        <p>Hi,</p>
        <p>To help us confirm your identity on Instagram, we need to verify your email address.</p>
        ...
        <p>This code will be expire three hours after this email was sent.</p>
        <p>Thanks,</p>
